...
//-remover   caractere   de   determinada   posiçãoda   lista,   retornando   o   elemento   que   foi removido, caso a operação não possa ser realizada, mostre mensagem avisando;
	...
	public static void main(String[] args) {
		...
		opcao=Integer.parseInt(JOptionPane.showInputDialog("Cadastro\n1 - Verificar se está vazia \n2 - Verificar se está cheia "
			...
			case 2:
				...
				break;
			case 3:
				letra = JOptionPane.showInputDialog("Caractere a ser adicionado no início:").charAt(0);
			...
			case 8:
				...
				if (posicao > 4 || posicao < 1) {
					...
					posicao = posicao -1;
					JOptionPane.showMessageDialog(null,"O valor removido na posição selecionada foi => " + ex.tiraPosicao(posicao));
				}
				break;
			case 9:
